...
<?php if (have_posts()) : ?>
	...
	<div class="entries">
		...
		<?php while (have_posts()) : the_post(); ?>
			<li><a href="<?php the_permalink(); ?>" rel="bookmark" title="<?php esc_attr( sprintf( __( 'Permanent Link to %s', 'vigilance' ), the_title_attribute( 'echo=false' ) ) ); ?>"><span class="comments-number"><?php comments_number( '0', '1', '%', '' ); ?></span><span class="archdate"><?php the_time( __( 'n.j.y', 'vigilance' )); ?></span><?php the_title(); ?></a></li>
