...
<body <?php body_class(); ?>>
	...
	<div id="wrapper">
		<div id="header" class="clear">
			<?php if ($vigilance->logoState() == 'true' ) : ?>
				<div id="title-logo">
					<?php $alt = $vigilance->logoAlt() !== '' ? $vigilance->logoAlt() : get_bloginfo( 'name' ); ?>
					<a href="<?php echo home_url( '/' ); ?>"><img src="<?php echo esc_attr( $vigilance->logoName() ); ?>" alt="<?php echo esc_attr( $alt ); ?>"/></a>
				</div>
				<?php if ($vigilance->logoTagline() == 'true' ) : ?>
					<div id="description">
		...
		<?php if ( is_page_template( 'left-sidebar.php' ) ) : ?>
			<?php get_sidebar(); ?>
		<?php endif; ?>
		<div id="content" class="pad <?php echo ( is_page_template( 'no-sidebar.php' ) ? 'no-sidebar' : '' ); ?>">
			<?php if ( ! is_page_template( 'no-sidebar.php' ) ) :
				get_template_part( 'header-banner' );
			endif; ?>
			<?php if ( is_front_page() ) :
				get_template_part( 'header-alertbox' );
			endif; ?>